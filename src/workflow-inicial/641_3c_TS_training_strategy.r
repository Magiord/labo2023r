...
PARAM <- list()
PARAM$experimento <- "TS6410_3c"

PARAM$exp_input <- "FE6310_3"
...
PARAM$final_train <- c(
  202012, 202011, 202010, 202009, 202008,202007,202006,202005,202004, 201912,
  201911, 201910, 201909, 201908, 201907
)

PARAM$train$training <- c(
  202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 20204, 201912, 201911,
...
PARAM$train$semilla <- 650011 # cambiar por su propia semilla  !!!
