...
PARAM$RandomForest$num.trees <- 120
PARAM$RandomForest$max.depth <- 10
PARAM$RandomForest$min.node.size <- 10000
PARAM$RandomForest$mtry <- 40
PARAM$RandomForest$semilla <- 650011 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 919837
