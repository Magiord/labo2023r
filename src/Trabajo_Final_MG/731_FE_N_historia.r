...
PARAM <- list()
PARAM$experimento <- "FE7310_n3"

PARAM$exp_input <- "DR7210_n1"
...
PARAM$RandomForest$semilla <- 450123 # cambiar por la propia semilla


# varia de 0.0 a 2.0, si es 0.0 NO se activan
PARAM$CanaritosAsesinos$ratio <- 1.5
# desvios estandar de la media, para el cutoff
PARAM$CanaritosAsesinos$desvios <- 3.5
# cambiar por la propia semilla
PARAM$CanaritosAsesinos$semilla <- 450001
