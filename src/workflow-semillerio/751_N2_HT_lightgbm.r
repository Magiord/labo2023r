...
PARAM <- list()
PARAM$experimento <- "HT7510_n2"

PARAM$exp_input <- "TS7410_n1mes"

# En caso que se haga cross validation, se usa esta cantidad de folds
PARAM$lgb_crossvalidation_folds <- 5

PARAM$lgb_semilla <- 650011 # cambiar por su propia semilla
...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeIntegerParam("lambda_l1", lower = 0L, upper = 200L),
  makeIntegerParam("lambda_l2", lower = 0L, upper = 200L),
